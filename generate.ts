...
export function generate(inputLocation, outputLocation) {
  const graphqlString = (await fs.readFile('')).toString()
  ...
  await fs.writeFile('./prisma/generated/properties.ts', file)
}
